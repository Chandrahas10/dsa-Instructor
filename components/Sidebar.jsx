...
const Sidebar = ({expand,setExpand}) => {
  ...
  return (
    <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all 
      ...
      <div>
        <div className={`flex ${expand ? "flex-row gap-10" : "fles-col items-center gap-8"}`}>
            ...
            className='group relative flex items-center justify-center 
                    hover:bg-grey-500/20 transition-all duration-300 h-9 w-9 aspect-square
                 ...
                 <div className={`absolute w-max ${expand ? "left-1/2 -translate-x-1/2 top-12":
                        "-top-12 left-0"} opacity-0 group-hover:opacity-100 transition bg-black 
        ...
        <button className={`mt-8 flex items-center justify-center cursor-pointer ${
            ...
            <Image className={expand ? 'w-6': 'w-7'} src={expand ? assets.chat_icon :
             assets.chat_icon_dull} alt=''/>
      ...
      <div>
        <div className={`flex items-center cursor-pointer group relative ${expand ?
            "gap-1 text-white/80 text-sm p-2.5 border-primary rounded-lg hover:bg-white/10 cursour-pointer":
            "h-10 w-10 mx-auto hover:bg-grey-500/30 rounded-lg" }`}>
            ...
            <div className={` absolute -top-60 pb-8 ${!expand && "-right-40"}
                ...
                <p className={`w-3 h-3 absolute bg-black rotate-45 
                    ${expand ? "right-1/2": "left-4"}-bottom-1.5`}></p>
                </div>
            </div>
